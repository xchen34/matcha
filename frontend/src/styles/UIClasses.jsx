...
export const primaryButtonClass =
  "inline-flex items-center justify-center rounded-full bg-primary-dark from-primary to-primary-dark px-5 py-2.5 text-sm font-semibold text-white shadow-md hover:scale-105 hover:shadow-lg transition-all duration-200";

export const secondaryButtonClass =
  "inline-flex items-center justify-center rounded-full border border-primary bg-white px-4 py-2.5 text-sm font-semibold text-neutral-dark hover:bg-primary-medium transition-all duration-200";
...
export const chatButtonClass = (isDisabled) =>
  isDisabled
    ? "inline-flex items-center justify-center rounded-full bg-neutral-light px-4 py-3 text-base font-semibold text-white shadow-lg opacity-60 cursor-not-allowed"
    : "inline-flex items-center justify-center rounded-full bg-primary-light from-primary to-primary-dark px-4 py-3 text-base font-semibold text-white shadow-lg hover:-translate-y-0.5 transition";