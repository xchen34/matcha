export default function ChatConversationStatusBadge({
  ...
  if (conversation?.blocked_by_you) {
    return (
      <li className="text-center py-3">
        <span className="inline-flex rounded-full border border-red-300 bg-red-100 px-4 py-2 text-sm font-medium text-red-800">
  ...
  if (conversation?.blocked_you) {
    return (
      <li className="text-center py-3">
        <span className="inline-flex rounded-full border border-red-300 bg-red-100 px-4 py-2 text-sm font-medium text-red-800">
          You've been blocked by @{otherUsername}
        </span>
      </li>
    );
  }
  ...
  if (
    ...
    return (
      <li className="text-center py-3">
        <span className="inline-flex rounded-full bg-green-100 px-4 py-2 text-sm font-medium text-green-800 border border-green-300">
  ...
  if (
    ...
    return (
      <li className="text-center py-3">
        <span className="inline-flex rounded-full bg-red-100 px-4 py-2 text-sm font-medium text-red-800 border border-red-300">
